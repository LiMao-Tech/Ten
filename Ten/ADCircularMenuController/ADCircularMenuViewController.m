...
-(id)initWithFrame:(CGRect)frame {
    ...
    NSArray * names = [[NSArray alloc] initWithObjects: @"btn_menu_search_female", @"btn_menu_search_male", @"btn_menu_search_all", @"user_pic_88", @"btn_menu_chat_normal", @"btn_menu_notification_normal", @"btn_menu_setting", @"btnMenu", nil];
    if (self)
    {
